        ...
        <section className='fourth-heghlight-wrapper'>
          <div className='row'>
            <Fourth
              ...
              innerclassName='left-side-inner-wrapper'
              imgName='watch-series5-logo'
              description='With the new Always-On Retina display. 
									You’ve never seen a watch like this.'
            />
            <Fourth
              wrapperClass='right-side-wrapper'
              innerclassName='right-side-inner-wrapper'
              imgName='apple-card-logo'
              description='Get 3% Daily Cash on purchases from Apple using Apple Card.'
            />
          </div>
        </section>
